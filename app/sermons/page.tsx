    ...
    <div className="min-h-screen">
      ...
      <section className="hero-gradient py-32 text-center bg-center bg-no-repeat">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <Link 
            href="/studio" 
            className="bg-faith-gold text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-yellow-500 transition-all duration-300 shadow-lg"
          >
            Preach a New Sermon →
          </Link>
        </div>
          ...
          {sermons.length === 0 ? (
            <div className="text-center py-24">
              <p className="text-2xl text-gray-500 mb-8">
                No sermons yet. Be the first to share God's word!
              </p>
              <Link 
                href="/studio" 
                className="bg-faith-blue text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-blue-600 transition-all duration-300 shadow-lg"
              >
